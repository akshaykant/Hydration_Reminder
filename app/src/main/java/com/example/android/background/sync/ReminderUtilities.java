...
public class ReminderUtilities {
    // TASK (4.15) Create three constants and one variable:
    ...
    // TASK (4.16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context) {
        ...
        // TASK (4.17) If the job has already been initialized, return
        if (sInitialized) return;

        // TASK (4.18) Create a new GooglePlayDriver
        Driver driver = new GooglePlayDriver(context);
        // TASK (4.19) Create a new FirebaseJobDispatcher with the driver
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(driver);

        // TASK (4.20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // TASK (4.21) Use dispatcher's schedule method to schedule the job
           /* Schedule the Job with the dispatcher */
        dispatcher.schedule(constraintReminderJob);

        // TASK (4.22) Set sInitialized to true to mark that we're done setting up the job
